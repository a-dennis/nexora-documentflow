...
st.markdown(r"""
<style>
:root{--blue:#5B7DB1;--indigo:#4f46e5;--violet:#7c3aed;--cyan:#0891b2;--green:#16a34a;--orange:#f97316;--pink:#ec4899;--ink:#252637;--muted:#687083}
...
.stButton>button,.stDownloadButton>button{min-height:42px!important;border-radius:13px!important;font-weight:800!important;border:1px solid #B7C9E2!important;background:#EAF1FA!important;color:#29415F!important;box-shadow:0 3px 10px rgba(52,73,94,.08)!important;transition:background .16s ease,box-shadow .16s ease,border-color .16s ease!important}
.stButton>button:hover,.stDownloadButton>button:hover{border-color:#9FB5D3!important;background:#DCE7F5!important;color:#203852!important;box-shadow:0 5px 14px rgba(52,73,94,.11)!important}
.stButton>button:active,.stDownloadButton>button:active{background:#CFDDF0!important;border-color:#8FA9CA!important;color:#1F3650!important;transform:none!important}
.stButton>button{position:relative!important;z-index:20!important;pointer-events:auto!important;line-height:1.2!important}
.workspace-choice{min-height:180px!important}.workspace-choice button{min-height:150px!important;font-size:1.08rem!important;border-radius:20px!important;background:#EAF1FA!important;border:2px solid #B7C9E2!important;color:#29415F!important;box-shadow:0 5px 16px rgba(52,73,94,.08)!important}.workspace-choice button:hover{background:#DCE7F5!important;border-color:#9FB5D3!important;box-shadow:0 8px 20px rgba(52,73,94,.11)!important}
.stButton>button[kind="primary"],.stButton>button[kind="primary"] p,.stButton>button[kind="primary"] span,.stButton>button[kind="primary"] div{color:#29415F!important}.stButton>button[kind="primary"]{border:1px solid #B7C9E2!important;background:#EAF1FA!important;box-shadow:0 4px 12px rgba(52,73,94,.09)!important}
.stButton>button[kind="primary"]:hover{background:#DCE7F5!important;border-color:#9FB5D3!important;box-shadow:0 6px 16px rgba(52,73,94,.12)!important}
.money-player{border:2px solid #B7C9E2!important;background:#F4F7FB!important;box-shadow:0 8px 22px rgba(52,73,94,.07)!important}.money-player:hover{border-color:#9FB5D3!important;background:#EAF1FA!important;box-shadow:0 10px 26px rgba(52,73,94,.10)!important}.option-card{min-height:78px!important}.option-card button{min-height:54px!important;font-size:.96rem!important}.selected-option button{border:2px solid #8FA9CA!important;background:#EAF1FA!important;color:#29415F!important}.home-mini-card{min-height:118px!important}.home-mini-card button{min-height:48px!important}.stSelectbox{display:none!important}.hr-hero{padding:.2rem 0 .35rem}.hr-badge{display:inline-block;padding:.28rem .7rem;border-radius:999px;background:#F4F7FB;border:1px solid #B7C9E2;font-weight:800;color:#456789}.hr-card-title{font-weight:850}.hr-note{font-size:.86rem;color:#687083}.stButton>button[kind="secondary"]{font-weight:700!important}@media(max-width:900px){.block-container{padding-left:.55rem!important;padding-right:.55rem!important}h1{letter-spacing:-1.8px!important;font-size:2rem!important}h2{font-size:1.45rem!important}h3{font-size:1.15rem!important}.stButton>button,.stDownloadButton>button{min-height:44px!important}.stTextInput input,.stTextArea textarea{font-size:16px!important}.payment-cta{padding:.45rem}.privacy-note{font-size:.72rem}}
</style>
