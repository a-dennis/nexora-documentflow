...
.stButton>button,.stDownloadButton>button{min-height:42px!important;border-radius:13px!important;font-weight:800!important;border:1px solid rgba(236,72,153,.20)!important;background:linear-gradient(135deg,#fff7fb 0%,#fce7f3 48%,#ede9fe 100%)!important;color:#6b214f!important;box-shadow:0 7px 18px rgba(236,72,153,.10),0 2px 6px rgba(79,70,229,.05)!important;transition:transform .16s ease,box-shadow .16s ease,border-color .16s ease,background .16s ease!important}
.stButton>button:hover,.stDownloadButton>button:hover{border-color:rgba(236,72,153,.48)!important;background:linear-gradient(135deg,#fce7f3 0%,#f5d0fe 50%,#e0e7ff 100%)!important;color:#5b1740!important;box-shadow:0 11px 26px rgba(236,72,153,.18),0 4px 12px rgba(79,70,229,.09)!important;transform:translateY(-1px)!important}
...
.workspace-choice{min-height:180px!important}.workspace-choice button{min-height:150px!important;font-size:1.08rem!important;border-radius:20px!important;background:linear-gradient(135deg,#fff1f7 0%,#fce7f3 42%,#ede9fe 100%)!important;border:2px solid rgba(236,72,153,.22)!important;color:#5b1740!important;box-shadow:0 12px 30px rgba(236,72,153,.12),0 4px 14px rgba(79,70,229,.06)!important}.workspace-choice button:hover{background:linear-gradient(135deg,#fce7f3 0%,#f5d0fe 48%,#ddd6fe 100%)!important;border-color:rgba(236,72,153,.52)!important;box-shadow:0 18px 38px rgba(236,72,153,.20),0 7px 18px rgba(79,70,229,.10)!important}
