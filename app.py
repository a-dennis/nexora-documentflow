...
.stButton>button,.stDownloadButton>button{min-height:42px!important;border-radius:13px!important;font-weight:800!important;border:1px solid #2563eb!important;background:#2563eb!important;color:#fff!important;box-shadow:0 5px 14px rgba(37,99,235,.14)!important;transition:background .16s ease,box-shadow .16s ease,border-color .16s ease!important}
...
.stButton>button:active,.stDownloadButton>button:active{background:#1e40af!important;transform:none!important}
