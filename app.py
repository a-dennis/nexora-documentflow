...
st.markdown(r"""
<style>
:root{--blue:#e5322d;--indigo:#4f46e5;--violet:#7c3aed;--cyan:#0891b2;--green:#16a34a;--orange:#f97316;--pink:#ec4899;--ink:#252637;--muted:#687083}
...
.stButton>button,.stDownloadButton>button{min-height:42px!important;border-radius:13px!important;font-weight:800!important;border:1px solid #e5322d!important;background:#e5322d!important;color:#fff!important;box-shadow:0 5px 14px rgba(37,99,235,.14)!important;transition:background .16s ease,box-shadow .16s ease,border-color .16s ease!important}
...
.stButton>button:active,.stDownloadButton>button:active{background:#b71c1c!important;transform:none!important}
